...
#' @param outfile The name of output file in GTF format
...
#' @param gtffile Character, GTF files assembled from transcripts by stringtie
...
#' @param bamfile Path for BAM files.
